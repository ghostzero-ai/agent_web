...
| 4.2 ✅ | 新闻聚类、去重和反馈 | 已完成：同任务 30 天来源按规范 URL 与近似标题聚类，全部重复时静默跳过；Inbox 可反馈并直达主题/频率编辑 |
...
当前优先级遵循产品主线指导。Mobile M1.3 保留为真机验收清单，不继续扩张厂商适配；Core 3.1–3.5 已封版，Phase 4.1–4.2 已完成有来源的个人简报、跨期聚类去重和轻量反馈。下一步进入 Phase 4.3：在同一主动内容闭环中加入有来源的书籍资料与最小阅读画像。
