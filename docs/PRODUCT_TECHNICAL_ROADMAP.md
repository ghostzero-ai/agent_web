...
| 0.6 | 依赖安全与 Phase 0 封版 | 升级 Next.js 修复生产依赖公告，完整检查通过并形成可回滚 Git 基线 |
...
| Sprint | 内容 | 验收 |
|---|---|---|
| 1.1 | PostgreSQL + Drizzle + migration 基线 | 本地可建库、升级、回滚 |
| 1.2 | Conversation/Message Repository 和 API | 刷新、换设备可读取同一数据 |
